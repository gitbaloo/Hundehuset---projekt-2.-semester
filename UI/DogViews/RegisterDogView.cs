    ...
    public class RegisterDogView
    {
        ...
        public void ShowView()
        {
            ...
            while (registerDogExit == false) // loop will run until x has been pressed
            {
                ...
                bool correctPedigreeNumberInput = false;

                while (correctPedigreeNumberInput == false)
                {
                    ...
                    {
                        correctPedigreeNumberInput = true;
                    ...
                    else if (!dogController.IsDogInDatabase(pedigreeNumber)) // no dog with the selected pedigreeNumber was found in our database
                    {
                        ...
                        while (correctBirthDateInput == false) // loops until there is a propor input
                        {
                            ...
                            {
                                Console.WriteLine("The entered birthdate is invalid. Please use the proper format (dd-mm-yyyy). No input is also accepted.");
                        ...
                        while (correctSexInput == false)
                        {
                            ...
                            else if (char.TryParse(inputSex, out sex)) // is it posible to parse the input to a char
                            {
                                ...
                                {
                                    Console.WriteLine("The entered sex is invalid. Only 'T' or 'H' are accepted. No input is also accepted.");
                        ...
                        while (correctChipInput == false)
                        {
                            ...
                            {
                                Console.WriteLine("The entered chipnumber is invalid. Only letters, digits and dashes (-) are accepted. No input is also accepted.");
                            }
                        }
                        ...
                        while (correctHdStatusInput == false)
                        {
                            ...
                            else if (char.TryParse(inputHdStatus, out hdStatus)) // it is possible to parse the input to a char
                            {
                                ...
                                {
                                    Console.WriteLine("The entered HD-status is invalid. Only 'A', 'B', 'C', 'D' or 'E' are accepted. No input is also accepted.");
                                    continue; // goes back to the start of the while loop
                                }
                            }
                        ...
                        while (correctSpondylosisStatusInput == false)
                        {
                            ...
                            else if (int.TryParse(inputSpondylosisStatus, out spondylosisStatus)) // it is possible to parse the input to a char
                            {
                                ...
                                {
                                    Console.WriteLine("The entered Spondylosis status is invalid. Only integers from 1 to 4 are accepted. No input is also accepted.");
                                    continue; // goes back to the start of the while loop
                                }
                            }
                            else
                        ...
                        while (correctHeartStatusInput == false)
                        {
                            ...
                            else if (int.TryParse(inputHeartStatus, out heartStatus)) // it is possible to parse the input to a char
                            {
                                ...
                                {
                                    Console.WriteLine("The entered heart status is invalid. Only integers from 1 to 4 are accepted. No input is also accepted.");
                                    continue; // goes back to the start of the while loop
                                }
                            }
                            else
                        ...
                        while (correctColorInput == false)
                        {
                            ...
                            {
                                Console.WriteLine("The entered color is invalid. Only 'RG', 'TG', 'RG/HV', 'TG/HV' or 'Ufarve' are accepted. No input is also accepted.");
                                // and the while loop will start over
                            }
                        }
                        ...
                        while (correctIsAliveInput == false)
                        {
                            ...
                            {
                                Console.WriteLine("The entered input is invalid. Only 'yes' are 'no' are accepted. No input is also accepted (will default to 'yes').");
                                // and the while loop will start over
                            }
                        }
                        ...
                        while (correctMomPedigreeNumberInput == false)
                        {
                            ...
                            {
                                Console.WriteLine("The entered pedigree number is invalid. Only letters and digits - no spaces or special characters. No input is also accepted.");
                            }
                        }
                        //DadPedigreeNumber
